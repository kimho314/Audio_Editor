...
const Signup = () => {
	...
	const createUserApi = async (userId, userPw, userName) => {
		let userInfo = { userId: userId, userPw: userPw, userName: userName };

		const result = await axios
			.post("http://localhost:3001/signup", userInfo, {
				headers: {
	...
	const handleSubmit = async (e) => {
		...
		let userInfo = { id: userId, password: userPw, userName: userName };
		try {
